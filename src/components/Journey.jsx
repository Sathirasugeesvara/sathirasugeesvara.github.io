        ...
        <div className="relative">
          ...
          <div className="space-y-6">
            {timeline.map((item) => {
              ...
              return (
                <div key={item.title} className="relative flex gap-5 md:gap-6">
                  ...
                  <div className="flex-1 rounded-2xl border border-base-border bg-base-panel p-5 md:p-6 hover:border-accent/40 transition-colors">
