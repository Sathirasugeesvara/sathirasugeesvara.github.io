...
// Same EmailJS project you were already using — swap these three IDs
// in your EmailJS dashboard if you ever want to change where mail is sent.
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid sm:grid-cols-2 gap-4">
            <input
              ...
              className="rounded-xl bg-base-panel border border-base-border px-4 py-3 text-sm text-ink placeholder:text-ink-faint focus:border-accent outline-none"
            />
            <input
              type="email"
              name="email"
          ...
          <textarea
            ...
            className="rounded-xl bg-base-panel border border-base-border px-4 py-3 text-sm text-ink placeholder:text-ink-faint focus:border-accent outline-none resize-none"
          />
          <button
            type="submit"
            disabled={status === 'sending'}
            className="rounded-full bg-accent px-6 py-3 font-display text-sm font-medium text-base hover:bg-accent-bright transition-colors disabled:opacity-60"
          >
